...
public class AbstractController {
    ...
    public ErrorResponse notFound(final EmptyResultDataAccessException exception, final HttpServletRequest request) {
        getLogger().error("Object not foud", exception);
    ...
    public ErrorResponse validationFailed(final MethodArgumentNotValidException ex, final HttpServletRequest request) {
        getLogger().error("Validation error", ex);
